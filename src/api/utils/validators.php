...
/** 
 * Valida que un rol dado sea uno de los roles permitidos definidos en ALLOWED_ROLES.
 *
 ...
 * @throws InvalidArgumentException Si alguna clave requerida está ausente, tiene el tipo incorrecto o contiene un valor inválido.
 */
function validateAllowedRole(string $role): void {

    // Validar que el rol sea uno de los valores permitidos
    if (!in_array($role, ALLOWED_ROLES, true)) {
        throw new InvalidArgumentException(
            "Rol inválido: '$role'. Los roles permitidos son: " . implode(', ', ALLOWED_ROLES) . "."
        );
    }
