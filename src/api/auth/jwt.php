 ...
 * Tokens carry the user identity and role needed by the router to
...
class JWT {
     ...
     *
     * El token contiene: ID de usuario, correo electrónico, rol, fecha de emisión y expiración.
     ...
     * @param string $dbName Nombre de la base de datos del usuario (opcional, no incluido en el token).
     * @return string Cadena JWT firmada en formato header.payload.signature.
     */
    public function generate(int $id, string $email, string $role, string $name, string $dbName): string {
